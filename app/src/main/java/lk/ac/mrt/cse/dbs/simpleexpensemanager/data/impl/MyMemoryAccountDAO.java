 ...
 */
public class MyMemoryAccountDAO extends SQLiteOpenHelper implements AccountDAO {
    //private final Map<String, Account> accounts;

    public static final String DATABASE_NAME = "150584M.db";
    ...
    public MyMemoryAccountDAO(Context context) {
